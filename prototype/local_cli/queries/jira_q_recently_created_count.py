...
def main() -> int:
    parser = argparse.ArgumentParser(description="Recently created issues count")
    parser.add_argument("--scope", choices=["project", "sprint"], default=os.getenv("RC_SCOPE", "project"))
    parser.add_argument("--project", help="Project key when scope=project")
    parser.add_argument("--days", type=int, default=int(os.getenv("RECENT_DAYS", "7")))
