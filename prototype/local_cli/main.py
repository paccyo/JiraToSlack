...
try:
    ...
    from prototype.local_cli.Loder.board_selector import resolve_board_with_preferences
    ...
    from prototype.local_cli.Loder.board_selector import resolve_board_with_preferences  # type: ignore
try:
