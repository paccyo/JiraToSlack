...
def main() -> int:
    parser = argparse.ArgumentParser(description="Overdue issues count")
    parser.add_argument("--scope", choices=["project", "sprint"], default=os.getenv("OD_SCOPE", "sprint"))
